...
function Header() {
    const navArray = [
        ...
        {navName : 'Items', navPath : '/items'},
        {navName : 'Forms', navPath : '/forms'},
        {navName : 'Products', navPath : '/products'},
        {navName : 'Props', navPath :'/Dropdown',
            subMenu :[{subName :'Example1', subPath:'/Example1'},
                     {subName :'Example2',subPath:'/Example2'}
            ]
        },
        {navName : 'Form Handling', navPath :'/Dropdown',
          subMenu :[{subName :'Submit Form', subPath:'/form1'},
                   {subName :'Edit & Delete',subPath:'/form2'}
          ]
      },
      {navName : 'API', navPath :'/Dropdown',
        subMenu :[{subName :'Api1', subPath:'/Api1'},
       ...
       { navArray.map((value, index)=>{
        return(
          ...
          <ul className="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
            ...
            return <>  <li>
                <Link className="dropdown-item" to={item.subPath}>
            {item.subName}</Link></li> </>
             }
        )}
                ...
                <Link className="nav-link active" aria-current="page" to={value.navPath}>{value.navName}</Link>
            </li>
            </>)
       );
    }
